...
export const UserProvider = ({ children }) => {
    ...
    const [isStoreConnected, setIsStoreConnected] = useState();
    ...
    return (
        <Usercontext.Provider value={{ userdata, isStoreConnected, setIsStoreConnected, fetchUserInfo, handleLogOut }}>
            {!loading && children}
